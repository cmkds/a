...
<div class="login-box">
  ...
  <div class="login-box-body">
	...
	<fmt:message key="LOGMSG" />
    </p>

    <form action="./loginProcess.jsp" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="email" placeholder=" <fmt:message bundle="${message}" key="EMAIL" />">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="password" placeholder="<fmt:message bundle="${message}" key="PASSWORD" />">
    ...
    <div class="social-auth-links text-center">
      <p>- <fmt:message bundle="${message}" key="OR" /> - </p>
    ...
    <a href="#"> <fmt:message bundle="${message}" key="FORGOT" /></a><br>
    <a href="register.html" class="text-center"><fmt:message bundle="${message}" key="REGISTER" /></a>
