...
<div class="login-box">
  ...
  <div class="login-box-body">
	...
	<fmt:message bundle="${message}" key="LOGMSG" />
    Sign in to start your session</p>

    <form action="./loginProcess.jsp" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="email" placeholder="Email <fmt:message bundle="${message}" key="EMAIL" />">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="password" placeholder="Password <fmt:message bundle="${message}" key="PASSWORD" />">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              ...
              <fmt:message bundle="${message}" key="REMEMBERME" />
            </label>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-xs-4">
          ...
          <fmt:message bundle="${message}" key="SIGNIN" />
          </button>
        </div>
        <!-- /.col -->
      </div>
    ...
    <div class="social-auth-links text-center">
      <p>- OR - <fmt:message bundle="${message}" key="OR" /> </p>
    ...
    <a href="#">I forgot my password <fmt:message bundle="${message}" key="FORGOT" /></a><br>
    <a href="register.html" class="text-center">Register a new membership <fmt:message bundle="${message}" key="REGISTER" /></a>
